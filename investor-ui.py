...
class BuyToLetUI(QMainWindow, Ui_MainWindow):
    ...
    def calc(self):
        ...
        #Mortgage
        self.weekly_mortgage.setText(str(calc_mortgage(property_price, ltv, mortgage_ir, 30, "WEEK")))
        self.monthly_mortgage.setText(str(calc_mortgage(property_price, ltv, mortgage_ir, 30, "MONTH")))
        self.yearly_mortgage.setText(str(calc_mortgage(property_price, ltv, mortgage_ir, 30, "YEAR")))
        ...
        # Profit net
        self.weekly_profit_net.setText(str(calc_profit_net(property_price, ltv, mortgage_ir, 30, rent_pm, "WEEK")))
        self.monthly_profit_net.setText(str(calc_profit_net(property_price, ltv, mortgage_ir, 30, rent_pm, "MONTH")))
        self.yearly_profit_net.setText(str(calc_profit_net(property_price, ltv, mortgage_ir, 30, rent_pm, "YEAR")))
